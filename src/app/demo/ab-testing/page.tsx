...
function DesignA() {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Traditional Layout</h3>
      <div className="space-y-4">
        <div className="bg-gray-100 dark:bg-gray-700 h-32 rounded flex items-center justify-center">
          <span className="text-gray-500 dark:text-gray-400">Hero Section</span>
        </div>
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-gray-100 dark:bg-gray-700 h-24 rounded flex items-center justify-center">
            <span className="text-gray-500 dark:text-gray-400">Feature 1</span>
          </div>
          <div className="bg-gray-100 dark:bg-gray-700 h-24 rounded flex items-center justify-center">
            <span className="text-gray-500 dark:text-gray-400">Feature 2</span>
          </div>
          <div className="bg-gray-100 dark:bg-gray-700 h-24 rounded flex items-center justify-center">
            <span className="text-gray-500 dark:text-gray-400">Feature 3</span>
          </div>
        </div>
        <button className="w-full bg-gray-800 dark:bg-gray-600 text-white py-2 rounded hover:bg-gray-700 dark:hover:bg-gray-500 transition-colors">
    ...
    <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg shadow-sm border border-blue-200 dark:border-blue-700 p-6">
      ...
      <div className="space-y-4">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur h-32 rounded-lg flex items-center justify-center shadow-sm">
          <span className="text-blue-600 dark:text-blue-400 font-medium">Enhanced Hero</span>
        </div>
        <div className="space-y-3">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur h-20 rounded-lg flex items-center px-4 shadow-sm">
            <div className="w-12 h-12 bg-blue-500 dark:bg-blue-600 rounded-lg mr-4"></div>
            <span className="text-gray-700 dark:text-gray-300">Feature with Icon</span>
          </div>
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur h-20 rounded-lg flex items-center px-4 shadow-sm">
            <div className="w-12 h-12 bg-indigo-500 dark:bg-indigo-600 rounded-lg mr-4"></div>
            <span className="text-gray-700 dark:text-gray-300">Feature with Icon</span>
          </div>
        </div>
...
export default function ABTestingDemo() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">A/B Testing</h1>
        ...
        <div className="space-y-4">
          ...
          {isLoading ? (
            <div className="h-64 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center">
              <span className="text-gray-500 dark:text-gray-400">Loading design...</span>
            </div>
          ) : showModernDesign ? (
            <DesignB />
          ) : (
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-3">
            <h4 className="font-medium text-gray-900 dark:text-white">Test Setup</h4>
          ...
          <div className="space-y-3">
            <h4 className="font-medium text-gray-900 dark:text-white">Using Feature Flags</h4>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              <li className="flex items-start">
                <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
